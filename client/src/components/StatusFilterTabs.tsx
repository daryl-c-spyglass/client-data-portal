          ...
          <span 
            className={cn(
              ...
              activeFilter === filter.key 
                ...
                : filter.key === 'underContract' ? `${STATUS_COLORS.underContract.bgLight} ${STATUS_COLORS.underContract.text} dark:bg-primary/20 dark:${STATUS_COLORS.underContract.textDark}`
