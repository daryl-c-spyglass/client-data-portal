  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        {showFilters && (
          <Card className="xl:col-span-1 flex flex-col" style={{ maxHeight: 'calc(100vh - 200px)' }}>
            <CardHeader>
            ...
            <CardContent className="flex-1 overflow-y-auto">
              <Accordion type="multiple" defaultValue={["core", "location"]} className="space-y-2">
                <AccordionItem value="core" className="border rounded-lg">
                  <AccordionTrigger className="px-4 py-3 hover:no-underline">
                    <span className="font-medium text-sm">Core Filters</span>
                  </AccordionTrigger>
                ...
                <AccordionItem value="ai-search" className="border rounded-lg">
                  <AccordionTrigger className="px-4 py-3 hover:no-underline">
                    <span className="font-medium text-sm">AI & Quick Search</span>
                  </AccordionTrigger>
                  <AccordionContent className="px-4 pb-4 space-y-6">
                ...
                <AccordionItem value="schools" className="border rounded-lg">
                  <AccordionTrigger className="px-4 py-3 hover:no-underline">
                ...
                <AccordionItem value="property" className="border rounded-lg">
                  <AccordionTrigger className="px-4 py-3 hover:no-underline">
                    <span className="font-medium text-sm">Property Details</span>
                  </AccordionTrigger>
                  <AccordionContent className="px-4 pb-4 space-y-6">
                    {/* Property Subtype */}
                    <div className="space-y-3">
                ...
                <AccordionItem value="features" className="border rounded-lg">
                  <AccordionTrigger className="px-4 py-3 hover:no-underline">
                    <span className="font-medium text-sm">Features & Amenities</span>
                  </AccordionTrigger>
                  <AccordionContent className="px-4 pb-4 space-y-6">
                    {/* Interior Features */}
                    <div className="space-y-3">
                ...
                <AccordionItem value="outdoor" className="border rounded-lg">
                  <AccordionTrigger className="px-4 py-3 hover:no-underline">
                    <span className="font-medium text-sm">Outdoor & Lot</span>
                  </AccordionTrigger>
                  <AccordionContent className="px-4 pb-4 space-y-6">
                    {/* Lot Features */}
                    <div className="space-y-3">
                ...
                <AccordionItem value="construction" className="border rounded-lg">
                  <AccordionTrigger className="px-4 py-3 hover:no-underline">
                    <span className="font-medium text-sm">Construction & Systems</span>
                  </AccordionTrigger>
                  <AccordionContent className="px-4 pb-4 space-y-6">
                    {/* Foundation Details */}
                    <div className="space-y-3">
                ...
                <AccordionItem value="dates" className="border rounded-lg">
                  <AccordionTrigger className="px-4 py-3 hover:no-underline">
                    <span className="font-medium text-sm">Dates & Status</span>
                  </AccordionTrigger>
                  <AccordionContent className="px-4 pb-4 space-y-6">
                    {/* Date Range */}
                    <div className="space-y-3">
